...
class CustomBottomNavigation2 extends StatefulWidget {
  final Function _addingThings;
  final String carName;
  final Function cameraFunction;

  // const CustomBottomNavigation({super.key});
  CustomBottomNavigation2({Key? key, required Function addingThings, required String carName, required Function cameraFunction})
      : _addingThings = addingThings, carName = carName, cameraFunction = cameraFunction,
        super(key: key);


  @override
  State<CustomBottomNavigation2> createState() => _CustomBottomNavigationState2();
}

class _CustomBottomNavigationState2 extends State<CustomBottomNavigation2> {
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(icon: Icon(Icons.camera_alt), onPressed: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => GalleryScreen2(carName: widget.carName)));
                }),
                IconButton(icon: Icon(Icons.photo_library), onPressed: () {
                  Navigator.push(context, PageTransition(type: PageTransitionType.leftToRight, child: GalleryScreen2(carName: widget.carName,)));
